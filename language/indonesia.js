...
saya REALZI BOT, bot ini adalah Beta Multi-Device Whatsapp. 
SILAHKAN LAPOR OWNER JIKA MENEMUKAN BUG DI DALAM BOT.
`
}
exports.listMenu = (time, salam, pushname, prefix) => {
    return `*Selamat ${salam} ${pushname}*
*Time Server : ${time}*
*List-Menu Realzi-bot :*
...
Sanksi: *PERMANENT BLOCK*
 ...
 Untuk sementara bot dalam status berbayar to add.
...
Jika sudah dipahami rules-nya, silakan ketik *${prefix}allmenu* untuk memulai!
 ...
 Segala kebijakan dan ketentuan Realzibot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Realzibot
😖🙏
`
}
exports.welcome = () =>{
...
exports.leave = () =>{
	return`Yah kok out :(, jaga diri baik2 yaa...
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Recode : https://github.com/Fauzibanh
`
}
